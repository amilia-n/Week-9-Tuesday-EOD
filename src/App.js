        ...
        <div className="App">
            <header className="App-header">
                ...
                <p>
                    ...
                    <button onClick={() => setColor('#6187fb')} style={{marginRight: '10px'}}>Blue</button>
                    <button onClick={() => setColor('#95e868')} style={{marginRight: '10px'}}>Green</button>
                    <button onClick={() => setColor('#e86a68')} style={{marginRight: '10px'}}>Red</button>
                </p>
            </header>
        </div>
    );
